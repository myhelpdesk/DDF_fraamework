...
//extends FunctionLibrary for precondition(before test) and postcondition(after test) purpose
public class AppTest extends FunctionLibrary {
	//FileInput folder in LoginData excel path sttored in inputpath
		String inputpath ="./FileInput\\LoginData.xlsx";
		//FileOutput folder path(after execution this folder file path selenium create automatically)
		...
		public void startTest() throws Throwable
		{
			...
			//to store the resultant value of methode(adminLogin) in res
			boolean res =false;
